...
public final class DuctEntry {
    public final DuctConnectBlock b;
    public final BlockPos pos;
    private BlockState state;

    public DuctEntry(DuctConnectBlock b, BlockPos pos, BlockState state) {
        this.b = b;
        this.pos = pos;
        this.state = state;
    }
    ...
    public String toString() {
        return String.format("DuctEntry { b: %s, pos: %s, state: %s }", this.b, this.pos, this.state);
    }
}