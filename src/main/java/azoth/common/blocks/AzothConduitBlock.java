...
public class AzothConduitBlock extends Block {
    ...
    public BlockState getStateForNeighborUpdate(BlockState state, Direction direction, BlockState newState, WorldAccess world, BlockPos pos, BlockPos posFrom) {
        return this.connectToNeighbors(state, world, pos);
    }

    @Override
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        return this.connectToNeighbors(this.getDefaultState(), ctx.getWorld(), ctx.getBlockPos());
    }

    protected BlockState connectToNeighbors(BlockState state, WorldAccess world, BlockPos pos) {
    ...
    protected boolean connectsTo(WorldAccess world, BlockPos pos, Direction side) {
        BlockState state = world.getBlockState(pos);
        Block block = state.getBlock();
        return block instanceof AzothConduitBlock || block instanceof ConduitConnectable && ((ConduitConnectable) block).connectsToConduit(state, side);
    }
